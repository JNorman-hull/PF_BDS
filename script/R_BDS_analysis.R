...
rapid_dir <- file.path(batch_meta_dir, "RAPID")
...
process_batch_files(batch_meta_dir, bds100_dir, bds250_dir, rapid_dir)
...
BDSAnalysisTool(batch_summary, data_250hz, data_100hz, data_100_imp, 100)
